"""
Dynamic Link Prediction with a TGR-GIN model with Early Stopping
Reference: 
    - https://github.com/pyg-team/pytorch_geometric/blob/master/examples/tgn.py

command for an example run:
    python3 tgr-gin.py --data "tgbl-wiki" --num_run 1 --seed 1 --num_epoch=100 --lr=5e-4 
"""
...
exp_gnn = ExpanderGIN(in_channels=MEM_DIM, out_channels=EMB_DIM).to(device)
